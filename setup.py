...
setup(name='docassemble.2024ALAAConference',
      ...
      license='Copyright (c) 2024 Flinders University',
      url='https://docassemble.org',
      packages=find_packages(),
      namespace_packages=['docassemble'],
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/2024ALAAConference/', package='docassemble.2024ALAAConference'),
     )
